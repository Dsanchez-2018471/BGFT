...
export const Tegnologia = () => {
  return (
    ...
    <div className='container'>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=365053"><button>Obtener Proyect</button></a>
...
BackboneJs</p>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=365432"><button>Obtener Proyect</button></a>
...
W3C</p>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=365072"><button>Obtener Proyect</button></a>
    ...
    <div className='container'>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=418060"><button>Obtener Proyect</button></a>
    ...
    <div className='container'>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=418058"><button>Obtener Proyect</button></a>
    ...
    <div className='container'>
        ...
        <a href="https://kinal.academy/mod/assign/view.php?id=418062"><button>Obtener Proyect</button></a>
